...
async function main() {
  ...
  console.log(`Found ${placeholders.length} placeholder products. Updating to nice names...`);

  for (const p of placeholders) {
    const newName = `Sample Product ${p.id}`;
  ...
  console.log('Rename to nice names complete.');
}
